...
*                      (2)、本程序用于演示TCP 客户端通讯，单片机收到数据后，回传给远端。
...
/* CH561相关定义 */
UINT8 MACAddr[6] = {0x02,0x03,0x04,0x05,0x06,0x17};                             /* MAC地址 */
UINT8 IPAddr[4] = {192,168,0,2};                                                /* IP地址 */
...
/*******************************************************************************
* Function Name  : CH561ET_HandleSockInt
...
/*******************************************************************************
* Function Name  : CH561ET_CreatTcpSocket
