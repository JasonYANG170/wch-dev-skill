...
UINT8   CH561MACAddr[MACADDR_LEN]= {0x02,0x23,0x34,0x45,0x56,0x67};             /* MAC地址 */
UINT8   CH561IPAddr[IPADDR_LEN]  = {192,168,1,10};
...
* Description    : 系统定时器初始化，CH561@100MHZ TIME0 10ms，根据CH561NETTIMEPERIOD
*                ：来初始化定时器。
* Input          : None
* Output         : None
* Return         : None
