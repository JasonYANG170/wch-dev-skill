...
/**********************************************************************************
* Function Name  : CH561NET_IcmpRecvData
* Description    : 接收数据
* Input          : None
* Output         : None
* Return         : None
...
/**********************************************************************************
* Function Name  : CH561NET_PINGCmd
* Description    : 查询状态执行相应命令
* Input          : None
* Output         : None
* Return         : None
**********************************************************************************/
void CH561NET_PINGCmd( void )                                          
{
    if( IcmpSuc<ICMP_KEEP_NO ){
        switch(IcmpSuc){
            case ICMP_SOKE_CON:
                IcmpSuc = 1;
                TimeCount = 0;
                CH561NET_PINGSendData( SEND_BUF,40,0);
