...
const UINT8 IPAddr[4] = {192,168,0,101};                                        /* IP地址 */
const UINT8 GWIPAddr[4] = {192,168,0,1};                                        /* 网关 */
const UINT8 IPMask[4] = {255,255,255,0};                                        /* 子网掩码 */
const UINT8 DESIP[4] = {192,168,0,100};                                         /* 目的IP地址 */
...
/*******************************************************************************
* Function Name  : CH561NET_CreatUpdSocket
* Description    : 创建UDP socket
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void CH561NET_CreatUpdSocket(void)
{
   UINT8 i;                                                             
...
int main( void ) 
{
    ...
    InitSysHal();                                                               /* 初始化中断 */
    CH561NET_CreatUpdSocket();                                                  /* 创建UDP Socket */
