...
* Version            : V1.0
* Date               : 2017/3/8
* Description        : CH561 IAP DEMO

*******************************************************************************/
/*说明：该例程需增加库文件\SRC\ISPXT56X.O*/
/******************************************************************************/
/* 头文件包含 */
#include <stdio.h>
#include <string.h>
...
*******************************************************************************/
__align(4)   CONST UINT8 CH561DEMO_BIN[] ={
...
/*******************************************************************************
* Function Name  : CH561_FLASH_CODE
* Description    : 更新falsh
* Input          : None
* Output         : None
* Return         : None
*******************************************************************************/
void CH561_FLASH_CODE( void ) 
{
    UINT32 i;
    ...
    PRINT("flash Write:\n");
    i = FLASH_ROM_WRITE( 0,(PVOID)CH561DEMO_BIN,sizeof(CH561DEMO_BIN) );        /* 更新用户程序，用户程序从0x00000000地址开始 */                        
    if( i ){
        PRINT("    *** Write Error***\n");
    }
    else{
    ...
    PRINT("flash  verify:\n");
    i = FLASH_ROM_VERIFY( 0,(PVOID)CH561DEMO_BIN,sizeof(CH561DEMO_BIN) );       /*  校验是否正确 */
    if( i ){
        PRINT("    *** verify Error***\n");
        while(1){
