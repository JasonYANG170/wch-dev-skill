...
* Description    : CH555时钟选择和配置函数,复位默认使用内部晶振，Fsys=12MHz，
...
* Description    : CH555串口0引脚映射,串口映射到P0.2和P0.3
* Input          : None
* Return         : None
*******************************************************************************/
...
* Description    : CH555串口0初始化,默认使用T1作波特率发生器，也可使用T2
