...
* Version            : V1.0
* Date               : 2021/07/16
* Description        : CH555 Time 初始化、定时器、计数器赋值、T2捕捉功能开启函数等
                       定时器中断函数
*********************************************************************************
...
* Description    : CH555定时计数器2 T2EX引脚捕捉功能初始化（CAP2 P11）
* Input          : mode：边沿捕捉模式选择
*                   0或2：T2ex从下降沿到下一个下降沿
*                   1：T2ex任意边沿之间
*                   3：T2ex从上升沿到下一个上升沿
...
* Description    : CH555定时计数器2 T2引脚捕捉功能初始化T2(CAP1 P10)
* Input          : mode,边沿捕捉模式选择
*                   0或2:T2ex从下降沿到下一个下降沿
*                   1:T2ex任意边沿之间
*                   3:T2ex从上升沿到下一个上升沿
