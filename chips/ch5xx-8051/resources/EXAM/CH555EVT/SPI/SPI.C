...
* Version            : V1.0
* Date               : 2021/07/16
* Description        : CH555 SPI主、从模式接口函数
...
/*******************************************************************************
* Function Name  : CH555SPIMasterWrite
* Description    : CH555硬件SPI写数据,主机模式
* Input          : dat：发送数据
* Return         : None
*******************************************************************************/
void CH555SPIMasterWrite(UINT8 dat)
{
	SPI0_DATA = dat;
...
/*******************************************************************************
* Function Name  : CH555SPIMasterRead
* Description    : CH555硬件SPI0读数据，主机模式
* Input          : None
* Return         : ret：接收数据
*******************************************************************************/
UINT8 CH555SPIMasterRead(void)
{
...
/*******************************************************************************
* Function Name  : CH555SPISlvWrite
* Description    : CH555硬件SPI写数据，从机模式
* Input          : dat：发送数据
* Return         : None
*******************************************************************************/
void CH555SPISlvWrite(UINT8 dat)
{
	SPI0_DATA = dat;
...
/*******************************************************************************
* Function Name  : CH555SPISlvRead
* Description    : CH555硬件SPI0读数据，从机模式
* Input          : None
* Return         : ret：接收数据
*******************************************************************************/
UINT8 CH555SPISlvRead(void)
{
	while(S0_FREE == 0)
	{
			;
