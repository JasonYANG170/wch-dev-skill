...
#ifndef __CH32F10x_USBFS_HOST_H
#define __CH32F10x_USBFS_HOST_H
...
extern __attribute__((aligned(4))) uint8_t  USBFS_RX_Buf[ MAX_PACKET_SIZE ];
extern __attribute__((aligned(4))) uint8_t  USBFS_TX_Buf[ MAX_PACKET_SIZE ];
